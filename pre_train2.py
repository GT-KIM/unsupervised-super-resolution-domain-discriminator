...
from pretrain_generator import pretrain_generator2 , test_pretrain_generator
...
# HR_data_dir LR_data_dir npz_data_dir HR_npz_filename LR_npz_filename save_data
...
parser.add_argument('--gan_loss_type', dest='gan_loss_type', default='RaGAN', help='the type of GAN loss functions. "RaGAN" or "GAN"')

# About training
parser.add_argument('--num_iter', dest='num_iter', type=int, default=50000, help='The number of iterations')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=8, help='Mini-batch size')
...
parser.add_argument('--pre_train_checkpoint_dir', dest='pre_train_checkpoint_dir', type=str, default='./pre_train_checkpoint2', help='pre-train checkpoint directory')
parser.add_argument('--pre_valid_result_dir', dest='pre_valid_result_dir', default='/sdc1/NTIRE2020/pre_result2/valid_result', help='output directory during training')
parser.add_argument('--pre_valid_LR_result_dir', dest='pre_valid_LR_result_dir', default='/sdc1/NTIRE2020/pre_result2/valid_LR_result', help='output directory during training')
parser.add_argument('--pre_train_result_dir', dest='pre_train_result_dir', default='./sdc1/NTIRE2020/pre_result2/pre_train_result', help='output directory during training')
parser.add_argument('--pre_raw_result_dir', dest='pre_raw_result_dir', default='./sdc1/NTIRE2020/pre_result2/pre_raw_result', help='output directory during training')
...
def main():
    ...
    if args.pretrain_generator:
        pretrain_generator2(args, logflag)
